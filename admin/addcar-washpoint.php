...
$sql="INSERT INTO tblwashingpoints(washingPointName,washingPointAddress,contactNumber,City) VALUES(:wpname,:wpaddress,:wpcnumber,:wpcnumbe)";
...
$query->bindParam(':wpcnumbe',$wpcnumbe,PDO::PARAM_STR);
$query->execute();
