...
{
$wpname=$_POST['Service'];
$wpaddress=$_POST['Cost'];	

$sql="INSERT INTO tblservices(Services,Cost) VALUES(:wpname,:wpaddress)";
...
if($lastInsertId)
{
 echo "<script>alert('Service was added successfully');</script>";
						...
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" name="Service" method="post" enctype="multipart/form-data">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control" name="Service" id="Service" placeholder="Cost" required>
									</div>
								</div>
