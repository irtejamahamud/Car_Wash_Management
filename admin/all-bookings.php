...
<div class="agile-grids">   
              ...
              <div class="container">
                <div class="section-header text-center">
                    <h2>Filter by Place and Date</h2>
                </div>
                        ...
                        <table id="table">
                                <caption>All booking Table</caption>
                        <thead>
                          <tr>
                          <th>Booking No.</th>
                            <th>Name</th>
            ...
            <?php 
                ...
                $place = $_POST['place'];
                $date = $_POST['date'];
                $sql = "SELECT * FROM tblcarwashbooking WHERE City = '$place' and washDate='$date'";
                ...
                if($query->rowCount()>0)
                {
                    ...
                    {   ?>  
                            ...
                            <td><a href="all-bookings.php?bid=<?php echo htmlentities($result->bid);?>&&bookingid=<?php echo htmlentities($result->bookingId);?>">View</a>
                            </td>
                            <?php } ?>
                            </tr>
                         <?php } else { ?>
