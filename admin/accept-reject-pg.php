...
<html lang="en">
<head>
<title>CWMS | Accept/Reject </title>
...
<!--heder end here-->
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="dashboard.php">Home</a><em class="fa fa-angle-right"></em>Manage All Bookings</li>
</ol>

                    <div class="agile-tables">
                    <form method = "post" action="accept.php">
										<div class="form-group row">
											<label for="ID" class="col-md-4 col-form-label text-md-right">Booking Id
                      </label>
											<div class="col-md-6">
                    ...
                    <div div class="col-md-2 text-center">
                      <button type="submit" class="btn btn-primary my-2" name="action" value="accept"  >Accept </button>
                    </div>
                    <div class="col-md-2 text-center">
                      <button type="submit" class="btn btn-primary my-2" name="action" value="reject"  >Reject </button>
                    </div>
                    </form>
                  </div>  
            ...
            if($ptype==1): echo "BASIC CLEANING (RS1000)";endif;
            if($ptype==2): echo "PREMIUM CLEANING (RS2000)";endif;
            if($ptype==3): echo "COMPLEX CLEANING (Rs3000)";endif;
            if($ptype==4): echo "SUPER DELUXE (Rs4000)";endif;
