...
<!--header end here-->
		<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="dashboard.php">Home</a> <em class="fa fa-angle-right"></em></li>
            </ol>
<!--four-grids here-->
		<div class="four-grids">

			<a href="totalbookings.php" target="_blank">
...
<a href="new-bookings.php" target="_blank">
					<div class="col-md-3 four-grid">
